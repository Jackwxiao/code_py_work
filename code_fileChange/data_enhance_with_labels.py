...
'''
@Project ：yolov5-v6.1 
@File    ：data_enhance_with_labels.py
@Author  ：Jackwxiao
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'D:\wx3.29\images_process\yancong_exhausting_gray\images/')
    parser.add_argument('--source_xml_path', type=str, default=r'D:\wx3.29\images_process\yancong_exhausting_gray\annotations/')
    parser.add_argument('--save_img_path', type=str, default=r'D:\wx3.29\images_process\yancong_exhausting_gray\enhance_53_images/')
    parser.add_argument('--save_xml_path', type=str, default=r'D:\wx3.29\images_process\yancong_exhausting_gray\enhance_53_xml/')
