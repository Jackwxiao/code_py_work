...
# location = os.getcwd() + '/C:/Anaconda3/envs/pytorch/Lib/site-packages/fake_useragent/fake_useragent_0.1.11.json'
# ua = UserAgent(path=location)
# location = UserAgent(path='C:/Anaconda3/envs/pytorch/Lib/site-packages/fake_useragent/fake_useragent_0.1.11.json')
# print(ua.random)
class Picture:
    ...
    def __init__(self):
        ...
        self.times = str(int(time.time()*10000)) #时间戳-->补全url
    ...
    def run(self):
        ...
        for i in range(pn): #遍历每一个含30张图片的链接
            resp = self.get_one_html(self.url, i * 40)
...
# https://blog.csdn.net/fenghefeng123/article/details/119239161?spm=1001.2101.3001.6650.2&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-2-119239161-blog-84143738.235%5Ev36%5Epc_relevant_default_base3&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-2-119239161-blog-84143738.235%5Ev36%5Epc_relevant_default_base3&utm_relevant_index=3